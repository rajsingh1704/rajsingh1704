...
class CollegeProfileGallery extends Component
{
    use WithFileUploads;
                ...
                <form wire:submit.prevent="uploadProfileImg" enctype= multipart/form-data >
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input type="file" class="form-control" name="gallery" id="gallery" wire:model="gallery" multiple />
                        </div>
