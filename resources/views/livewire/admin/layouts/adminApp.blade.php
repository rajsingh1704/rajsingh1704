            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-4 col-xl-3 align-self-center">
                        <div class="site-logo">
                            <a href=""> <img src="{{ asset('storage/system_img/logo1.png') }}" style="height:50px" alt="" class="img-fluid" />
                                {{-- <span style="color:#fff;font-size: 24px;margin-top: 5px;">COLLEGE TODAY</span> --}}
                            </a>
                        </div>
                                    ...
                                    <a  class="nav-link" data-toggle="dropdown" aria-expanded="false"> 
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body align-self-center">
                                                ...
                                                <small class="redial-primary-light font-weight-bold text-white"> Store Admin </small>
                                            </div>
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu border-bottom-0 rounded-0 py-0">
                                <li><a class="dropdown-item py-2" href="/admin/profile"><i class="fa fa-user pr-2"></i> My Profile</a></li>
                                {{-- <li><a class="dropdown-item py-2" href="#"><i class="fa fa-cog pr-2"></i> Setting</a></li> --}}
                                <li><a class="dropdown-item py-2" href="/admin/logout"><i class="fas fa-sign-out-alt pr-2"></i>Logout</a></li>
                            </ul>
                        </li>
...
<!-- jQuery -->
{{-- @livewire('../livewire/admin/course') --}}
...
<script>
    window.addEventListener('showCourse-form', event => {
        $('#modalForm').modal('show');
    })
    window.addEventListener('coseModal-form', event => {
        $('#modalForm').modal('hide');
    })

    window.addEventListener('summernoteData', event => {
